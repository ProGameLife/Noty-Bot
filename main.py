...
cim = '<@959341072692158506>'
twitchID = ['viichan6', 'cotton__123', 'jingburger', 'vo_ine', 'lilpaaaaaa', 'gosegugosegu', 'kimdoe', 'sal_gu', 'aba4647', 'zilioner']
    ...
    while True:
        ...
        for i, x in enumerate(twitchID):
            ...
            try:
                ...
                elif twitch_channel_response['user_login'] == 'zilioner':
                    await channel.send(cim + title + '\n' + category + ' ' + link)
                else:
